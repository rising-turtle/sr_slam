...
// #include "GraphWrapper.h"  // implement submap scheme 
...
void ui_connections(QObject* ui, CGraphWrapper* graph_mgr, OpenNIListener* listener)
{
...
int main(int argc, char** argv)
{
  ...
  QtROS qtRos(argc, argv, "sr_slam"); //ros node name & namespace
  ...
  COpenniWrapper* listener_w = new COpenniWrapper(graph_mgr);
  OpenNIListener* listener = dynamic_cast<OpenNIListener*>(listener_w);
